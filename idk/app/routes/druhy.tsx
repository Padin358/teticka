    ...
    <div className="bg-cyan-700 p-8">
      ...
      <div className="flex justify-center">
        <ul className="list-disc text-2xl marker:text-gray-50 text-gray-50 font-semibold mx-auto">
            <li className="my-1"><TextEl><a href="cenik#1" className="">Sportovní, rekondiční a regenerační masáže</a></TextEl></li>
            <li className="my-1"><TextEl><a href="cenik#2" className="">Hawai masáže</a></TextEl></li>
            <li className="my-1"><TextEl><a href="cenik#3" className="">Holistické aromaterapeutické masáže</a></TextEl></li>
            <li className="my-1"><TextEl><a href="cenik#4" className="">Reflexní terapie plosky nohy</a></TextEl></li>
            <li className="my-1"><TextEl><a href="cenik#5" className="">Manuální lymfatické masáže - MLM</a></TextEl></li>
            <li className="my-1"><TextEl><a href="cenik#6" className="">Spinal Touch</a></TextEl></li>
        </ul>
      </div>
      <div className="">
        ...
        <div className="w-full lg:w-164 mx-auto mt-10 text-xl text-gray-50">
