...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Masáže » Věra Zatloukalová" },
  ];
}
...
export default function Home() {
  return <div className="">
    ...
    <div className="bg-[url(../img/bgImg3.jpg)] bg-cover bg-center bg-origin-border h-[600px] -mt-16 relative z-0 opacity-60 transition-all"></div>
    ...
    <div className="bg-cyan-700 p-8">
      ...
      <div className="gap-10">
        ...
        <TextEl classes="mx-12 lg:mx-64 text-xl text-gray-50 mt-8 font-semibold"><strong className="font-black bg-linear-to-br from-yellow-100 to-yellow-400 bg-clip-text text-transparent">Masáže jsou většinou vnímány</strong> jako příjemná forma uvolnění, ale tak jako u cvičení je dobrá jistá pravidelnost.Samozřejmě, že pomůže i masáž 2x do roka, ale abychom si svou fyzickou i duševní kondici udržovali, <strong className="font-black bg-linear-to-br from-yellow-100 to-yellow-400 bg-clip-text text-transparent">je lepší na masáže pravidelně</strong>. <br />Lidé nejvíce vyžadují masáž zad a šíje, ovšem masáž celého těla je mnohem příjemnější a užitečnější. <br />Pro preventivní účely je vhodné navštěvovat masáže alespoň jednou měsíčně, v případě nějakého problému i několikrát týdně.</TextEl>
      </div>
      <div className="mt-10 font-black bg-linear-to-tl from-yellow-100 to-yellow-400 bg-clip-text text-transparent text-2xl text-center">
        <TextEl classes="">Používám za studena lisované oleje a přírodní bylinné masti. <br />Dále i přípravky od firmy <a href="https://www.justnahrin.cz/" className="text-yellow-500">Just</a>.</TextEl>
      </div>
