...
export default function Poukazy() {
  return <div className="">
    ...
    <div className="bg-[url(../../public/img/bgImg3.jpg)] bg-cover bg-center bg-origin-border h-[400px] -mt-16 relative z-0 opacity-80   transition-all"></div>
    ...
    <div className="bg-cyan-700 p-8">
      <TextEl classes="text-6xl xl:text-6xl font-black text-center bg-linear-to-br from-yellow-100 to-yellow-400 bg-clip-text text-transparent p-5">Dárkové Poukazy</TextEl>
        ...
        <TextEl classes="mx-102 text-xl text-gray-50 mt-8 font-semibold">Chcete li obdarovat své blízké, přátele či obchodní partnery, využijte naši nabídky dárkových poukazů na naše služby. Poukázky si u nás můžete objednat telefonicky, e-mailem, nebo při domluvené masáži. </TextEl>
        <TextEl classes="mx-102 text-xl text-gray-50 mt-8 font-semibold">Cena za objednaný dárkový poukaz se bude rovnat vybrané masáži, vynásobené objednaným počtem masáží, nebo bude vystaven na libovolnou částku (např. 300 Kč), a jednotlivé masáže se budou z této částky odečítat, až bude hodnota poukazu vyčerpána.</TextEl>
        <TextEl classes="mx-102 text-2xl text-gray-50 mt-8 font-semibold"><strong className="font-black bg-linear-to-br from-yellow-100 to-yellow-400 bg-clip-text text-transparent">Dárkový poukaz je platný po dobu 6 měsíců ode dne vydání, nebo dle dohody.</strong></TextEl>
        <TextEl classes="mx-102 text-xl text-gray-50 mt-8 font-semibold">V případě Vaši návštěvy bez předchozí domluvy se může stát, že nebudeme mít čas se Vám okamžitě věnovat. Jistě uznáte, že není možné odcházet od klienta v průběhu masáže. Děkujeme Vám za pochopení.</TextEl>
      </div>
