import { cenik3 } from "public/cenik"
import React from "react"

const Cenik3Tabulka = () => {
    return (
        <table className="table-auto w-full lg:w-2/3 border-collapse border border-cyan-900 text-gray-50 mx-auto my-16 font-semibold scale-85 lg:scale-100" id="3">
        <thead>
            <tr className="bg-cyan-800 font-extrabold text-sm lg:text-xl">
            <th className="border-2 border-cyan-900 p-2 w-124">Holistická aromaterapeutická masáž</th>
